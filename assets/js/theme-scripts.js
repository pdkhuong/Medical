...
function changeTraveloElementUI() {
    ...
    tjq('.datepicker-wrap input').datepicker({
        showOn: 'button',
        buttonImage: '/medical/assets/images/blank.png',
        buttonText: '',
...
tjq(window).load(function() {
    ...
    if (enableChaser == 1 && tjq('#content').length > 0 && tjq('#main-menu ul.menu').length > 0) {
        ...
        tjq('<h1 class="logo navbar-brand"><a title="Travelo - home" href="index.html"><img alt="" src="/medical/assets/images/logo.png"></a></h1>').insertBefore('.chaser .menu');
    ...
    tjq("body").on("click", "a.popup-gallery", function(e) {
        ...
        if (tjq("#soap-gallery-popup").length < 1) {
            tjq("<div class='opacity-overlay' id='soap-gallery-popup'><div class='container'><div class='popup-wrapper'><div class='popup-container'><i class='fa fa-spinner fa-spin spinner'></i><div class='col-sm-9 popup-content'></div></div></div></div></div>").appendTo("body");
        }
    ...
    tjq("body").on("click", ".popup-map", function(e) {
        ...
        if (typeof lngltd != "undefined") {
            ...
            if (tjq("#soap-map-popup").length < 1) {
                tjq("<div class='opacity-overlay' id='soap-map-popup'><div class='container'><div class='popup-wrapper'><div class='popup-container'><i class='fa fa-spinner fa-spin spinner'></i><div class='col-sm-9 popup-content'></div></div></div></div></div>").appendTo("body");
            }
